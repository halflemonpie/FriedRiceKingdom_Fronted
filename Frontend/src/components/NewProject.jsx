...
const NewForm = props => {
    ...
    return (
        <div> 
            ...
            <p className="input">Please input your new project information below:</p>
                ...
                <input required className="input" onChange={handleChange} type="number" max="5" min="0" name="importance" placeholder='importance'/>
                ...
                <input required className="input" onChange={handleChange} type="text" name="image" placeholder='image URL'/>
